 ...
 * This cell is non-selectable and immutable, displaying the default column names from sinset.fxml.
 */
public class TreatmentPlanProcedureHeaderCell extends ListCell<TreatmentPlanProcedure> {
     ...
     * This cell always displays the default column names from sinset.fxml.
     * 
